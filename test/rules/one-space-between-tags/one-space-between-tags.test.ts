...
test('accepts tags separated by a single space', () => {
  checkRule(rule, 'one-space-between-tags/NoViolations.feature', {}, []);
});

test('reports extra spacing between tags on one line', () => {
  checkRule(rule, 'one-space-between-tags/Violations.feature', {}, [
